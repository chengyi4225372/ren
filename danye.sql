...
Source Database       : danye

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2019-09-10 23:26:08
*/
...
-- ----------------------------
-- Table structure for dbanner
-- ----------------------------
DROP TABLE IF EXISTS `dbanner`;
...
-- Records of dbanner
-- ----------------------------
INSERT INTO `dbanner` VALUES ('13', null, '/static/upload/d368e061cb187aba/ce7b26dac22e539f.jpg', '1', '2019-09-09 17:06:50');
INSERT INTO `dbanner` VALUES ('10', '关于我们标题', '', '2', '2018-12-28 11:28:21');
INSERT INTO `dbanner` VALUES ('11', '标题2', '', '2', '2018-12-28 11:28:35');
INSERT INTO `dbanner` VALUES ('12', '百度', '', '3', '2018-12-28 11:28:48');

-- ----------------------------
-- Table structure for dfoot
-- ----------------------------
DROP TABLE IF EXISTS `dfoot`;
CREATE TABLE `dfoot` (
...
-- Records of dfoot
-- ----------------------------
INSERT INTO `dfoot` VALUES ('1', '/static/upload/07b72d851ac1617a/8fe32cca81e44bd2.png', null);
...
-- Records of foot
-- ----------------------------
INSERT INTO `foot` VALUES ('1', '/static/upload/07b72d851ac1617a/8fe32cca81e44bd2.png', null);
...
CREATE TABLE `other` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned DEFAULT NULL COMMENT '分类id',
  `title` varchar(200) DEFAULT NULL COMMENT '商品类型',
  `money` decimal(10,3) unsigned DEFAULT NULL COMMENT '金额',
  `jiang` decimal(10,3) unsigned DEFAULT NULL COMMENT '降价',
  `imgs` varchar(255) DEFAULT NULL COMMENT '图片',
  `url` text COMMENT 'link 连接',
  `ren` int(10) unsigned DEFAULT NULL COMMENT '强购人数',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
-- Records of other
-- ----------------------------
INSERT INTO `other` VALUES ('1', '2', '不知道', '10.000', '10.000', '/static/upload/c32399ba3a54e3d5/91263cef303f507f.jpg', 'https://www.baidu.com', '2500', '2019-09-09 16:18:36');
INSERT INTO `other` VALUES ('2', '1', '商品管理', '15.000', '20.000', '/static/upload/581ef248f3d47204/336ffbc6063e9fed.jpg', '', '25', '2019-09-09 16:30:09');
INSERT INTO `other` VALUES ('3', '3', '4564654', '10.000', '20.000', '/static/upload/91158e2da401f791/2120e81e3211c687.jpg', '', '4984', '2019-09-09 16:48:44');
INSERT INTO `other` VALUES ('4', '4', '自动发货', '400.000', '50.000', '/static/upload/91158e2da401f791/2120e81e3211c687.jpg', '', '49849', '2019-09-09 16:49:07');
INSERT INTO `other` VALUES ('5', '4', 'hahoa', '400.000', '10.000', '/static/upload/f290952e7ada3aff/1115fea130a41641.jpg', '', '5141', '2019-09-09 16:49:34');
INSERT INTO `other` VALUES ('6', '5', '465465', '440.000', '20.000', '/static/upload/dac7860159a81eb8/a7d293b5f03b5a8e.jpg', '', '456465', '2019-09-09 16:50:27');
INSERT INTO `other` VALUES ('7', '6', '不知道', '40.000', '10.000', '/static/upload/034ed80f2fa90a55/10dd0a02156d142d.jpg', '', '151', '2019-09-09 16:50:54');
INSERT INTO `other` VALUES ('8', '7', '商品管理', '10.000', '10.000', '/static/upload/c32399ba3a54e3d5/91263cef303f507f.jpg', '', '51', '2019-09-09 16:51:59');
INSERT INTO `other` VALUES ('9', '8', '65465465', '10.000', '1.000', '/static/upload/c32399ba3a54e3d5/91263cef303f507f.jpg', '', '10', '2019-09-09 16:53:09');
INSERT INTO `other` VALUES ('10', '8', '后台管理', '100.000', '10.000', '/static/upload/03ee4f23a48d7b3b/4824a994121fb1bc.jpg', '', '12', '2019-09-09 16:53:39');
INSERT INTO `other` VALUES ('11', '9', '人工发货', '100.000', '10.000', '/static/upload/7870f87feb87d098/9be387fc9aca19e4.jpg', '', '115', '2019-09-09 16:54:02');
INSERT INTO `other` VALUES ('12', '1', '订单管理', '10.000', '1.000', '/static/upload/2bc24c762be2dfb7/b85aba4b27247c3c.png', '', '156', '2019-09-09 22:20:39');
...
CREATE TABLE `qiang` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `imgs` varchar(255) DEFAULT NULL,
  `ren` varchar(200) DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL,
  `money` decimal(10,3) DEFAULT NULL,
  `jiang` decimal(10,3) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- Records of qiang
-- ----------------------------
INSERT INTO `qiang` VALUES ('1', '/static/upload/dbf63c833002892c/81ed37421a34f13a.jpg', '156', '', '10.000', '10.000', '商品列表');
...
CREATE TABLE `shop` (
  ...
  `bao` int(10) unsigned DEFAULT NULL COMMENT '爆买件数',
  `key` varchar(255) DEFAULT NULL COMMENT '介绍',
  `money` decimal(10,3) unsigned DEFAULT NULL COMMENT '金额',
  `url` text COMMENT 'URL连接',
  `imgs` varchar(255) DEFAULT NULL COMMENT '图片',
  `jiang` decimal(10,0) unsigned DEFAULT NULL COMMENT '领卷降价金额',
  PRIMARY KEY (`id`)
...
-- Records of shop
-- ----------------------------
INSERT INTO `shop` VALUES ('1', '不知道', '25', '54165465465465', '15.000', 'https://uland.taobao.com/coupon/edetail?e=XzOKrmcnowXsbecaumMgZDjnv6TgCO59eJoS%2FC1%2BC8Vyn7EwsE4CQ4PlCIl8sN3uqVg7N7pQr%2BDfzF%2BH4WAntXKPqIjfDmk4hLjdYI0pIJBToedDTP1a7xemP0hpIIPvjDppvlX%2Bob8NlNJBuapvQ2MDg9t1zp0RqpKCJa92K83f9DvjdRjRtUMuxoRQ3C%2BH3y5wGh39keyie%2FpBy9wBFg%3D%3D&traceId=0b14e50315680128236163339e&union_lens=lensId:0b01c1f1_0ca3_16d14d8ec5d_5707&xId=mdYA6kPFAxAE8CyK6IOnABiR2G6nzEJkGRaKV8mPvVaNjk6DzcW3GXrstsr9d3vlJZJ2pOV5DCmCnnDFwDjQ83&activityId=f76ef209a48244628722d65eb75a118a', '/static/upload/dac7860159a81eb8/a7d293b5f03b5a8e.jpg', '10');
