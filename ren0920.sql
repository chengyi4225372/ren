...
-- ----------------------------
-- Table structure for r_hudong
-- ----------------------------
DROP TABLE IF EXISTS `r_hudong`;
CREATE TABLE `r_hudong` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `mid` int(10) unsigned DEFAULT NULL COMMENT '用户id',
  `imgs` varchar(255) DEFAULT NULL,
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '发布时间',
  PRIMARY KEY (`id`)
...
-- Records of r_hudong
-- ----------------------------
INSERT INTO `r_hudong` VALUES ('0000000007', '6', '/static/upimgs/20190920/ab1e201e9bf46b96bcf7d092844b8a4d.jpg', '2019-09-20 15:15:43');
INSERT INTO `r_hudong` VALUES ('0000000008', '6', '/static/upimgs/20190920/49b21520df01f85725a68bd4bae01dcc.jpeg', '2019-09-20 15:17:27');
...
CREATE TABLE `r_member` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `orderNo` int(10) DEFAULT NULL COMMENT '编号',
  `users` varchar(50) DEFAULT NULL COMMENT '用户名',
  `pwd` char(32) DEFAULT NULL COMMENT '密码',
  `rand` char(10) DEFAULT NULL COMMENT '盐',
  `level` int(3) unsigned DEFAULT '1' COMMENT '等级',
  `status` int(3) unsigned DEFAULT '1' COMMENT '状态 1 正常 0 冻结',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `imgs` varchar(200) DEFAULT NULL COMMENT '用户头像',
  PRIMARY KEY (`id`)
...
-- Records of r_member
-- ----------------------------
INSERT INTO `r_member` VALUES ('0000000001', '0', '1346998741', 'ae8976985f3ed00262cd70d352a4d263', '6037', '1', '1', '2019-09-18 16:00:55', null);
INSERT INTO `r_member` VALUES ('0000000002', '0', '17353993431', '31d240282995de8424290439ae1522b7', '5775', '1', '1', '2019-09-19 09:20:49', null);
INSERT INTO `r_member` VALUES ('0000000003', '0', '18600578382', '462d78dfe376c468e9aa2be5884b49f4', '7348', '1', '1', '2019-09-19 09:23:03', null);
INSERT INTO `r_member` VALUES ('0000000004', '0', '18672536688', 'c5203a91421fed2066a0c7afe9d2b4ee', '3001', '1', '1', '2019-09-19 09:25:07', null);
INSERT INTO `r_member` VALUES ('0000000006', '0', '18672536001', '876a48e0dadb280821fb213e0a779f6b', '9090', '1', '1', '2019-09-20 11:12:48', null);

-- ----------------------------
-- Table structure for r_message
-- ----------------------------
DROP TABLE IF EXISTS `r_message`;
CREATE TABLE `r_message` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `hid` int(10) unsigned DEFAULT NULL COMMENT '互动id',
  `content` varchar(255) DEFAULT NULL COMMENT '评论',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_message
-- ----------------------------
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
INSERT INTO `system_log` VALUES ('239', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-18 16:35:46');
INSERT INTO `system_log` VALUES ('240', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 14:08:28');
INSERT INTO `system_log` VALUES ('241', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 14:11:46');
INSERT INTO `system_log` VALUES ('242', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 14:16:56');
INSERT INTO `system_log` VALUES ('243', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 14:25:12');
INSERT INTO `system_log` VALUES ('244', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 15:14:26');
INSERT INTO `system_log` VALUES ('245', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 15:14:30');
INSERT INTO `system_log` VALUES ('246', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 15:14:38');
INSERT INTO `system_log` VALUES ('247', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-19 15:16:12');
INSERT INTO `system_log` VALUES ('248', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-20 09:09:45');
INSERT INTO `system_log` VALUES ('249', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-09-20 09:41:33');
...
INSERT INTO `system_menu` VALUES ('118', '117', '图片设置', '', 'fa fa-battery-0', '#', '', '_self', '0', '1', '0', '2018-12-18 16:29:19');
INSERT INTO `system_menu` VALUES ('119', '118', '图片 未设置', '', 'fa fa-shopping-basket', '/tuanj/banner/index', '', '_self', '0', '1', '0', '2018-12-18 16:29:59');
...
INSERT INTO `system_menu` VALUES ('152', '117', '用户中心', '', 'fa fa-hotel', '#', '', '_self', '0', '1', '0', '2019-09-18 16:49:13');
INSERT INTO `system_menu` VALUES ('154', '152', '用户列表', '', 'fa fa-shopping-bag', '/tuanj/member/index', '', '_self', '0', '1', '0', '2019-09-18 16:50:00');
